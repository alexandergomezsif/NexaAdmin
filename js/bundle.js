    ...
    shippingBoxLabel(shipping) {
      ...
      <div style="flex: 1; border: 2px solid #000; border-radius: 8px; display: flex; flex-direction: column; justify-content: space-between; padding: 12px; box-sizing: border-box; overflow: hidden; position: relative;">
        ...
        <div style="display: flex; flex: 1; gap: 12px;">
          ...
          <!-- REMITENTE -->
          <div style="flex: 1; border: 2px solid #000; padding: 10px; border-radius: 4px; font-size: 11px; line-height: 1.3; display: flex; flex-direction: column; justify-content: center;">
            <div style="color: #444; margin-bottom: 8px; font-weight: bold; border-bottom: 1px solid #ccc; padding-bottom: 4px;">DE (REMITENTE):</div>
          ...
          <!-- DESTINATARIO -->
          <div style="flex: 2; border: 2px solid #000; padding: 10px; padding-right: 90px; border-radius: 4px; font-size: 12px; line-height: 1.4; display: flex; flex-direction: column; justify-content: center; background: #fffdf0; position: relative;">
            <div style="font-weight: 900; border-bottom: 1px solid #000; padding-bottom: 4px; margin-bottom: 6px;">PARA (DESTINATARIO):</div>
            <div style="font-weight: 900; font-size: 15px;">${shipping.clienteNombre}</div>
